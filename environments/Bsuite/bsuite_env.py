...
class BsuiteWrapper(gym.Env):
    ...
    * discounting_chain/N
    ...
    def __init__(self, env_name, env_params, reset_params = None, realtime_mode = False):
        ...
        if env_name == 'MemoryLength':
            ...
            self.max_episode_steps = env_params[0] + 1
        elif env_name == 'DiscountingChain':
            self._env = DiscountingChain(env_params[0])
